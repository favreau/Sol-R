...
static int16 s_std_croma_quant[64] = {17, 18, 18, 24, 21, 24, 47, 26, 26, 47,
...
void jpeg_encoder::optimize_huffman_table(int table_num, int table_len)
{
    ...
    huffman_enforce_max_code_size(num_codes, num_used_syms,
...
void jpeg_encoder::emit_sof()
{
    ...
    for (int i = 0; i < m_num_components; i++)
    {
        ...
        emit_byte((m_comp_h_samp[i] << 4) + m_comp_v_samp[i]); /* h and v
                                                                  sampling */
...
void jpeg_encoder::load_block_16_8(int x, int c)
{
    ...
    for (int i = 0; i < 16; i += 2, pDst += 8)
    {
        ...
        pDst[0] =
            ((pSrc1[0 * 3] + pSrc1[1 * 3] + pSrc2[0 * 3] + pSrc2[1 * 3] + a) >>
             2) -
            128;
        pDst[1] =
            ((pSrc1[2 * 3] + pSrc1[3 * 3] + pSrc2[2 * 3] + pSrc2[3 * 3] + b) >>
             2) -
            128;
        pDst[2] =
            ((pSrc1[4 * 3] + pSrc1[5 * 3] + pSrc2[4 * 3] + pSrc2[5 * 3] + a) >>
             2) -
            128;
        pDst[3] =
            ((pSrc1[6 * 3] + pSrc1[7 * 3] + pSrc2[6 * 3] + pSrc2[7 * 3] + b) >>
             2) -
            128;
        pDst[4] =
            ((pSrc1[8 * 3] + pSrc1[9 * 3] + pSrc2[8 * 3] + pSrc2[9 * 3] + a) >>
             2) -
            128;
        pDst[5] = ((pSrc1[10 * 3] + pSrc1[11 * 3] + pSrc2[10 * 3] +
                    pSrc2[11 * 3] + b) >>
                   2) -
                  128;
        pDst[6] = ((pSrc1[12 * 3] + pSrc1[13 * 3] + pSrc2[12 * 3] +
                    pSrc2[13 * 3] + a) >>
                   2) -
                  128;
        pDst[7] = ((pSrc1[14 * 3] + pSrc1[15 * 3] + pSrc2[14 * 3] +
                    pSrc2[15 * 3] + b) >>
                   2) -
                  128;
        int temp = a;
...
void jpeg_encoder::code_coefficients_pass_one(int component_num)
{
    ...
    uint32 *dc_count =
               component_num ? m_huff_count[0 + 1] : m_huff_count[0 + 0],
           *ac_count =
               component_num ? m_huff_count[2 + 1] : m_huff_count[2 + 0];
