...
extern "C" SOLR_API int SolR_GetOpenCLPlatformDescription(int platform,
                                                          char *value,
                                                          int valueLength);
extern "C" SOLR_API int SolR_GetOpenCLDeviceCount(int platform);
extern "C" SOLR_API int SolR_GetOpenCLDeviceDescription(int platform,
                                                        int device, char *value,
                                                        int valueLength);
...
extern "C" SOLR_API int SolR_SetPostProcessingInfo(int type, double param1,
                                                   double param2, int param3);

extern "C" SOLR_API int SolR_SetDraftMode(int draft);

extern "C" SOLR_API int SolR_InitializeKernel(bool activeLogging, int platform,
                                              int device);
extern "C" SOLR_API int SolR_FinalizeKernel();
extern "C" SOLR_API int SolR_ResetKernel();

extern "C" SOLR_API int SolR_GenerateScreenshot(char *filename, int width,
                                                int height, int quality);

// ---------- Camera ----------
extern "C" SOLR_API void SolR_SetCamera(double eye_x, double eye_y,
                                        double eye_z, double dir_x,
...
extern "C" SOLR_API int SolR_SetPrimitive(int index, double p0_x, double p0_y,
                                          double p0_z, double p1_x, double p1_y,
                                          double p1_z, double p2_x, double p2_y,
                                          double p2_z, double size_x,
                                          double size_y, double size_z,
                                          int materialId);

extern "C" SOLR_API int SolR_GetPrimitive(
    int index, double &p0_x, double &p0_y, double &p0_z, double &p1_x,
...
extern "C" SOLR_API int SolR_GetPrimitiveCenter(int index, double &x, double &y,
                                                double &z);

extern "C" SOLR_API int SolR_RotatePrimitive(int index, double rx, double ry,
                                             double rz, double ax, double ay,
                                             double az);

extern "C" SOLR_API int SolR_RotatePrimitives(int fromBoxId, int toBoxId,
...
extern "C" SOLR_API int SolR_SetPrimitiveNormals(int index, double n0_x,
                                                 double n0_y, double n0_z,
                                                 double n1_x, double n1_y,
                                                 double n1_z, double n2_x,
                                                 double n2_y, double n2_z);

extern "C" SOLR_API int SolR_SetPrimitiveTextureCoordinates(
    int index, double t0_x, double t0_y, double t1_x, double t1_y, double t2_x,
    double t2_y);

// ---------- Materials ----------
extern "C" SOLR_API int SolR_AddMaterial();
extern "C" SOLR_API int SolR_SetMaterial(
    int index, double color_r, double color_g, double color_b, double gloss,
...
extern "C" SOLR_API int SolR_GetMaterial(
    int index, double &color_r, double &color_g, double &color_b, double &gloss,
    double &reflection, double &refraction, int &procedural, int &wireframe,
    int &wireframeDepth, double &transparency, double &opacity,
...
extern "C" SOLR_API int SolR_GetTextureSize(int index, int &width, int &height,
                                            int &depth);
...
// ---------- Molecules ----------
extern "C" SOLR_API int SolR_LoadMolecule(char *filename, int geometryType,
                                          double defaultAtomSize,
                                          double defaultStickSize,
                                          int atomMaterialType, double scale);

// ---------- OBJ models ----------
extern "C" SOLR_API int SolR_LoadOBJModel(char *filename, int materialId,
                                          int autoScale, double scale,
...
#ifdef USE_KINECT
// ---------- Kinect ----------
extern "C" SOLR_API int SolR_UpdateSkeletons(
